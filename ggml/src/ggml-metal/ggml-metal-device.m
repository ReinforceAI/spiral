    ...
    switch (op->op) {
        ...
        case GGML_OP_FLASH_ATTN_EXT:
            ...
            if (op->src[1]->type != op->src[2]->type) {
                ...
                // - f16 x spiral_pq2 (Spiral pre-RoPE: K dequanted to F16 at graph level, V stays SPIRAL_PQ2)
                ...
                const bool k_is_f16_v_is_spiral = (op->src[1]->type == GGML_TYPE_F16 &&
                                                    op->src[2]->type == GGML_TYPE_SPIRAL_PQ2);
                const bool k_is_spiral_v_is_f16 = (op->src[1]->type == GGML_TYPE_SPIRAL_PQ2 &&
