...
GGML_API void quantize_row_spiral_pq2_ref(const float * GGML_RESTRICT x, block_spiral_pq2 * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_spiral_pq2(const block_spiral_pq2 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_spiral_pq2(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API void quantize_row_spiral_3bit_ref(const float * GGML_RESTRICT x, block_spiral_3bit * GGML_RESTRICT y, int64_t k);
