...
const spiral_weight_rotation * llama_memory_hybrid_context::get_spiral_weight_rotation(int64_t dim) const {
    return ctx_attn ? ctx_attn->get_spiral_weight_rotation(dim) : nullptr;
}
